...
class Botao extends React.Component < { children: React.ReactNode } > { //prop: nome da prop "propriedade "que nesse caso é texto com tipo string (isso para identificar que esta utilizando typescript e não react)
